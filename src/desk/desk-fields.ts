import { DESK_ROLES } from '@/auth/ability';
import { HOLDING_STATUSES, RESERVATION_STATUSES } from '@/desk/admin';
import { firstSchemaIssue } from '@/utils/form-kit';
import { LOAN_DAYS_MAX, LOAN_DAYS_MIN, normalizeClass } from '@/desk/borrow-fields';
