...
import { deleteLink, listDeskLinks, saveLink } from '$lib/server/desk/links';
import { authorOptions, bookOptions } from '$lib/server/desk/options';
import { actions, load } from '../+page.server';

vi.mock('$lib/server/desk/links', () => ({
	listDeskLinks: vi.fn(),
	saveLink: vi.fn(),
	deleteLink: vi.fn()
}));
